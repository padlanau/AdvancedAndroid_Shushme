...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
            ...
            Toast.makeText(context, "RINNGER SILENT", Toast.LENGTH_LONG).show();  // jojo added


        } else if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_EXIT) {
            setRingerMode(context, AudioManager.RINGER_MODE_NORMAL);

            Toast.makeText(context, "RINNGER NORMAL", Toast.LENGTH_LONG).show();  // jojo added
    ...
    private void sendNotification(Context context, int transitionType) {
        ...
        if (transitionType == Geofence.GEOFENCE_TRANSITION_ENTER) {
            ...
            Toast.makeText(context, "YOU ENTERED A GEOFENCE", Toast.LENGTH_LONG).show();  // jojo added
            ...
            Toast.makeText(context, "YOU EXIT A GEOFENCE", Toast.LENGTH_LONG).show();   // jojo added
        }
