...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onConnected(@Nullable Bundle connectionHint) {
        ...
        Toast.makeText(this, "API Client Connection Successful!", Toast.LENGTH_LONG).show();
    }
    ...
    public void onConnectionSuspended(int cause) {
        ...
        Toast.makeText(this, "API Client Connection Suspended!", Toast.LENGTH_LONG).show();
    }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult result) {
        ...
        Toast.makeText(this, "API Client Connection Failed!", Toast.LENGTH_LONG).show();
    }
